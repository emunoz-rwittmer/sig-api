...
const Product = require('./operations/inventory/product.models');
...
const initModels = () => {
    ...
    Passenger.belongsTo(Cruise, { as: 'cruise', foreignKey: 'cruise_id', });
    Cruise.hasMany(Passenger, { as: 'passengers', foreignKey: 'cruise_id', onDelete: 'CASCADE', hooks: true });
    ...
    CortecyCardItems.belongsTo(CortecyCard, { as: 'cortecy_card', foreignKey: 'cortecy_card_id', onDelete: 'CASCADE' });
