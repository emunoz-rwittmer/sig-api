...
const generateGeneralReportEvaluations = async (req, res) => {
    try {
        ...
        // console.log('reportingByYachtState', reportingByYachtState)
        // console.log('capitanesConEvaluaciones',capitanesConEvaluaciones)
        ...
        //     .string(`RAGO DE FECHAS: ${fechaFormateada(dataForReport.startDate) + " a " + fechaFormateada(dataForReport.endDate)}`)
