...
class Mails {
  ...
  static htmlContentEvaluationCrew(result, passwordGenerate) {
    const htmlContent = `
          <!DOCTYPE html>
          <html lang="es">
          <head>
          ...
          <body>
              <div class="container-pass">
                  ...
                  <div class="body-container">
                    <p>Las evaluaciones de desempeño para tu tripulación se ecuentran listas</p>
                    <p>por favor llenarlas lo antes posible, utiliza las siguientes credenciales para ingresar.</p>
                  </div>
                  <div class="credencial-container">
                    <h3 class="credential-tittle">User:</h3> <p>${result.email}</p>
                  </div>
  ...
  static htmlContentEvaluationCaptain(result, passwordGenerate) {
    const htmlContent = `
          <!DOCTYPE html>
          <html lang="es">
          <head>
          ...
          <body>
              <div class="container-pass">
                  ...
                  <p>Hola, ${result.first_name} ${result.last_name}</p>
                  <div class="body-container">
                    <p>Las evaluación de desempeño para tu capitán se ecuentran lista</p>
                    <p>por favor llenarla lo antes posible, utiliza el codigo para ingresar.</p>
                  </div>
                  <div class="credencial-container">
                    <h3 class="credential-tittle">Codigo:</h3> <p>${passwordGenerate} </p>
                  </div>
                  <div class="buttom-container">
                      <a href=${process.env.URL_CREWS} class="button">Iniciar sesión</a>
                  </div>
                  <div class="footer">
                    <p>Atentamente</p>
                    <h3>Rolf Wittmer</h3>
